...
using NetSpy.Decompiler.IL;
using NetSpy.Decompiler.ILSpy.Core.CSharp;
using NetSpy.Decompiler.ILSpy.Core.IL;
using NetSpy.Decompiler.ILSpy.Core.Settings;
using NetSpy.Decompiler.ILSpy.Core.Text;
using NetSpy.Decompiler.ILSpy.Core.XmlDoc;
using NetSpy.Decompiler.Utils;
using ICSharpCode.Decompiler.Disassembler;

namespace NetSpy.Decompiler.ILSpy.Core.Mixed {
	sealed class DecompilerProvider : IDecompilerProvider {
		readonly DecompilerSettingsService decompilerSettingsService;

		// Keep the default ctor. It's used by NetSpy.Console.exe
