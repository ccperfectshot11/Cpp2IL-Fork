	...
	sealed class CSharpVBDecompilerSettings : DecompilerSettingsBase {
		...
		IEnumerable<IDecompilerOption> CreateOptions() {
			yield return new DecompilerOption<string>(DecompilerOptionConstants.MemberOrder_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompilationOrder,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.AnonymousMethods_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompileAnonMethods,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.ExpressionTrees_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompileExprTrees,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.YieldReturn_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompileEnumerators,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.AsyncAwait_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompileAsyncMethods,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.AutomaticProperties_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompileAutoProps,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.AutomaticEvents_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompileAutoEvents,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.UsingStatement_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompileUsingStatements,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.ForEachStatement_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompileForeachStatements,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.LockStatement_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompileLockStatements,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.SwitchStatementOnString_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompileSwitchOnString,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.UsingDeclarations_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_AddUsingDeclarations,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.QueryExpressions_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_DecompileQueryExpr,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.FullyQualifyAmbiguousTypeNames_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_FullyQualifyAmbiguousTypeNames,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.FullyQualifyAllTypes_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_FullyQualifyAllTypes,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.UseDebugSymbols_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_UseLocalNameFromSyms,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.ObjectOrCollectionInitializers_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_ObjectOrCollectionInitializers,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.RemoveEmptyDefaultConstructors_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_RemoveEmptyDefaultCtors,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.IntroduceIncrementAndDecrement_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_IntroduceIncrementAndDecrement,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.MakeAssignmentExpressions_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_MakeAssignmentExpressions,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.AlwaysGenerateExceptionVariableForCatchBlocksUnlessTypeIsObject_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_AlwaysGenerateExceptionVariableForCatchBlocksUnlessTypeIsObject,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.ForceShowAllMembers_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_ShowCompilerGeneratedTypes,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.SortSystemUsingStatementsFirst_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_SortSystemFirst,
			...
			yield return new DecompilerOption<int>(DecompilerOptionConstants.MaxArrayElements_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_MaxArrayElements,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.SortCustomAttributes_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_SortCustomAttributes,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.UseSourceCodeOrder_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_UseSourceCodeOrder,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.AllowFieldInitializers_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_AllowFieldInitializers,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.OneCustomAttributePerLine_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_OneCustomAttributePerLine,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.TypeAddInternalModifier_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_TypeAddInternalModifier,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.MemberAddPrivateModifier_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_MemberAddPrivateModifier,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.RemoveNewDelegateClass_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_RemoveNewDelegateClass,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.EmitCalliAsInvocationExpression_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_EmitCalliAsInvocationExpression,
			...
			yield return new DecompilerOption<bool>(DecompilerOptionConstants.InsertParenthesesForReadability_GUID,
				...
				Description = NetSpy_Decompiler_ILSpy_Core_Resources.DecompilerSettings_InsertParenthesesForReadability,
