...
using NetSpy.Decompiler.ILSpy.Properties;
...
namespace NetSpy.Decompiler.ILSpy.Settings {
	sealed class CSharpDecompilerSettingsPage : AppSettingsPage, IAppSettingsPage2 {
		...
		static string ToString(DecompilationObject o) {
			switch (o) {
			case DecompilationObject.NestedTypes:	return NetSpy_Decompiler_ILSpy_Resources.DecompilationOrder_NestedTypes;
			case DecompilationObject.Fields:		return NetSpy_Decompiler_ILSpy_Resources.DecompilationOrder_Fields;
			case DecompilationObject.Events:		return NetSpy_Decompiler_ILSpy_Resources.DecompilationOrder_Events;
			case DecompilationObject.Properties:	return NetSpy_Decompiler_ILSpy_Resources.DecompilationOrder_Properties;
			case DecompilationObject.Methods:		return NetSpy_Decompiler_ILSpy_Resources.DecompilationOrder_Methods;
			default:
