...
namespace NetSpy.AsmEditor.Compiler {
	sealed class CompilerDiagnosticVM : ViewModelBase {
		...
		public string Line => Diagnostic.LineLocationSpan is null ? string.Empty : (Diagnostic.LineLocationSpan.Value.StartLinePosition.Line + 1).ToString();
		...
		void WriteSeverity(StringBuilder sb) {
			...
			case CompilerDiagnosticSeverity.Hidden:	sb.Append(NetSpy_AsmEditor_Resources.StatusHidden); break;
			case CompilerDiagnosticSeverity.Info:	sb.Append(NetSpy_AsmEditor_Resources.StatusInfo); break;
			case CompilerDiagnosticSeverity.Warning:sb.Append(NetSpy_AsmEditor_Resources.StatusWarning); break;
			case CompilerDiagnosticSeverity.Error:	sb.Append(NetSpy_AsmEditor_Resources.StatusError); break;
