...
namespace NetSpy.AsmEditor.Compiler {
	abstract class EditCodeVM : ViewModelBase, IDisposable {
		...
		public string AddAssemblyReferenceToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_AsmEditor_Resources.AddAssemblyReferenceToolTip, NetSpy_AsmEditor_Resources.ShortCutKeyCtrlO);
		public string AddGacReferenceToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_AsmEditor_Resources.AddGacReferenceToolTip, NetSpy_AsmEditor_Resources.ShortCutKeyCtrlShiftO);
		public string AddDocumentsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_AsmEditor_Resources.AddDocumentsToolTip, NetSpy_AsmEditor_Resources.ShortCutKeyCtrlShiftA);
		...
		void AddReferences(ModuleDef[] modules) {
			...
			try {
				if (!languageCompiler.AddMetadataReferences(mdRefs.ToArray()))
					MsgBox.Instance.Show(NetSpy_AsmEditor_Resources.Error_CouldNotAddAssemblyReferences);
			}
			catch (Exception ex) {
