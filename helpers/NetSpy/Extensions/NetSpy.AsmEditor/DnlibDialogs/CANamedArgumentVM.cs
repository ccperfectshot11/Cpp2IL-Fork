	...
	sealed class CANamedArgumentVM : ViewModelBase {
		...
		public string PickEnumToolTip {
			get {
				...
				return string.Format(NetSpy_AsmEditor_Resources.EnumType, EnumType.FullName);
			}
		}
		...
		static readonly EnumVM[] namedArgTypeEnumList = new EnumVM[] {
			new EnumVM(NamedArgType.Field, NetSpy_AsmEditor_Resources.CustomAttribute_NamedArg_Field),
			new EnumVM(NamedArgType.Property, NetSpy_AsmEditor_Resources.CustomAttribute_NamedArg_Property),
		};
