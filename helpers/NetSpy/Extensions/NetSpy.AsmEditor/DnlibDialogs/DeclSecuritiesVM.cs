...
namespace NetSpy.AsmEditor.DnlibDialogs {
	sealed class DeclSecuritiesVM : ListVM<DeclSecurityVM, DeclSecurity> {
		public DeclSecuritiesVM(ModuleDef ownerModule, IDecompilerService decompilerService, TypeDef? ownerType, MethodDef? ownerMethod)
			: base(NetSpy_AsmEditor_Resources.EditSecurityDeclaration, NetSpy_AsmEditor_Resources.CreateSecurityDeclaration, ownerModule, decompilerService, ownerType, ownerMethod) {
		}
