...
namespace NetSpy.AsmEditor.DnlibDialogs {
	...
	sealed class MarshalTypeVM : ViewModelBase {
		...
		static readonly EnumVM[] variantTypeList = new EnumVM[] {
			new EnumVM(VariantType.NotInitialized, NetSpy_AsmEditor_Resources.MarshalType_EnumNotInitialized),
		...
		public string SafeArrayMarshalType_UserDefinedSubType_TypeHeader =>
			string.Format(NetSpy_AsmEditor_Resources.Type, SafeArrayMarshalType_UserDefinedSubType_TypeSigCreator.TypeSigDnlibFullName);
		public string CustomMarshalType_CustMarshaler_TypeHeader =>
			string.Format(NetSpy_AsmEditor_Resources.Type, CustomMarshalType_CustMarshaler_TypeSigCreator.TypeSigDnlibFullName);
		...
		static void FixNativeTypeEnum(EnumListVM e, bool canHaveNotInitialized) {
			...
			if (canHaveNotInitialized)
				e.Items.Insert(0, new EnumVM(dnlib.DotNet.NativeType.NotInitialized, NetSpy_AsmEditor_Resources.MarshalType_EnumNotInitialized));
		}
