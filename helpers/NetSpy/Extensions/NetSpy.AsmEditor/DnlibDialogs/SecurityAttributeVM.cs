...
namespace NetSpy.AsmEditor.DnlibDialogs {
	sealed class SecurityAttributeVM : ViewModelBase {
		...
		void PickAttributeType() {
			...
			var newAttrType = dnlibTypePicker.GetDnlibType(NetSpy_AsmEditor_Resources.Pick_Type, new FlagsDocumentTreeNodeFilter(VisibleMembersFlags.TypeDef), AttributeType, ownerModule);
