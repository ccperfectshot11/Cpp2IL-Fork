...
namespace NetSpy.AsmEditor.Event {
	[ExportAutoLoaded]
	...
	sealed class DeleteEventDefCommand : IUndoCommand {
		...
		static string GetHeader(DocumentTreeNodeData[] nodes) {
			...
			return string.Format(NetSpy_AsmEditor_Resources.DeleteEvents, nodes.Length);
		}
		...
		public string Description => NetSpy_AsmEditor_Resources.DeleteEventCommand;
	...
	sealed class CreateEventDefCommand : IUndoCommand {
		...
		static void Execute(Lazy<IUndoCommandService> undoCommandService, IAppService appService, DocumentTreeNodeData[] nodes) {
			...
			win.Title = NetSpy_AsmEditor_Resources.CreateEventCommand2;
		...
		public string Description => NetSpy_AsmEditor_Resources.CreateEventCommand2;
	...
	sealed class EventDefSettingsCommand : IUndoCommand {
		...
		public string Description => NetSpy_AsmEditor_Resources.EditEventCommand2;
