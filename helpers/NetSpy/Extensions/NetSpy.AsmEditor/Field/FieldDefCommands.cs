...
namespace NetSpy.AsmEditor.Field {
	[ExportAutoLoaded]
	...
	sealed class DeleteFieldDefCommand : IUndoCommand {
		...
		static string GetHeader(DocumentTreeNodeData[] nodes) {
			...
			return string.Format(NetSpy_AsmEditor_Resources.DeleteFieldsCommand, nodes.Length);
		}
		...
		static void Execute(Lazy<IUndoCommandService> undoCommandService, DocumentTreeNodeData[] nodes) {
			...
			if (!Method.DeleteMethodDefCommand.AskDeleteDef(NetSpy_AsmEditor_Resources.AskDeleteField))
				return;
		...
		public string Description => NetSpy_AsmEditor_Resources.DeleteFieldCommand;
	...
	sealed class CreateFieldDefCommand : IUndoCommand {
		...
		static void Execute(Lazy<IUndoCommandService> undoCommandService, IAppService appService, DocumentTreeNodeData[] nodes) {
			...
			win.Title = NetSpy_AsmEditor_Resources.CreateFieldCommand2;
		...
		public string Description => NetSpy_AsmEditor_Resources.CreateFieldCommand2;
	...
	sealed class FieldDefSettingsCommand : IUndoCommand {
		...
		public string Description => NetSpy_AsmEditor_Resources.EditFieldCommand2;
