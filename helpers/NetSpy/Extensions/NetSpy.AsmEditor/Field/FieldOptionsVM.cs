...
namespace NetSpy.AsmEditor.Field {
	...
	sealed class FieldOptionsVM : ViewModelBase {
		...
		public string FieldTypeHeader => string.Format(NetSpy_AsmEditor_Resources.FieldType, TypeSigCreator.TypeSigDnlibFullName);
		...
		public string MarshalTypeString =>
			string.Format(NetSpy_AsmEditor_Resources.MarshalType, HasFieldMarshal ? MarshalTypeVM.TypeString : NetSpy_AsmEditor_Resources.MarshalType_Nothing);
		...
		public FieldOptionsVM(FieldDefOptions options, ModuleDef ownerModule, IDecompilerService decompilerService, TypeDef ownerType) {
			...
			ConstantVM = new ConstantVM(ownerModule, options.Constant?.Value, NetSpy_AsmEditor_Resources.Field_DefaultValueInfo);
