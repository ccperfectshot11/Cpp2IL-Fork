...
namespace NetSpy.AsmEditor.Hex.Nodes {
	sealed class PENode : DocumentTreeNodeData, IDecompileSelf {
		...
		public bool Decompile(IDecompileNodeContext context) {
			...
			context.Decompiler.WriteCommentLine(context.Output, NetSpy_AsmEditor_Resources.HexNode_PE);
			context.Decompiler.WriteCommentLine(context.Output, NetSpy_AsmEditor_Resources.NodesUseHexEditorMsg);
		...
		protected override void WriteCore(ITextColorWriter output, IDecompiler decompiler, DocumentNodeWriteOptions options) {
			output.Write(BoxedTextColor.Text, NetSpy_AsmEditor_Resources.HexNode_PE);
