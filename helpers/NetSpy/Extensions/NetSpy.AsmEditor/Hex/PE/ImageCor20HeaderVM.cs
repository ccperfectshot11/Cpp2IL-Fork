...
namespace NetSpy.AsmEditor.Hex.PE {
	sealed class ImageCor20HeaderVM : HexVM {
		...
		public ImageCor20HeaderVM(HexBuffer buffer, DotNetCor20Data cor20)
			...
			FlagsVM.Add(new BooleanHexBitField(NetSpy_AsmEditor_Resources.HexNode_Cor20Header_Flags_IL_Only, 0));
			FlagsVM.Add(new BooleanHexBitField(NetSpy_AsmEditor_Resources.HexNode_Cor20Header_Flags_32BitReqd, 1));
			FlagsVM.Add(new BooleanHexBitField(NetSpy_AsmEditor_Resources.HexNode_Cor20Header_Flags_ILLibrary, 2));
			FlagsVM.Add(new BooleanHexBitField(NetSpy_AsmEditor_Resources.HexNode_Cor20Header_Flags_StrongNameSigned, 3));
			FlagsVM.Add(new BooleanHexBitField(NetSpy_AsmEditor_Resources.HexNode_Cor20Header_Flags_NativeEntryPoint, 4));
			FlagsVM.Add(new BooleanHexBitField(NetSpy_AsmEditor_Resources.HexNode_Cor20Header_Flags_TrackDebugData, 16));
			FlagsVM.Add(new BooleanHexBitField(NetSpy_AsmEditor_Resources.HexNode_Cor20Header_Flags_32BitPref, 17));
