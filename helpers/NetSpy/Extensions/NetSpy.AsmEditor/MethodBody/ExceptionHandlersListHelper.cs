...
namespace NetSpy.AsmEditor.MethodBody {
	sealed class ExceptionHandlersListHelper : ListBoxHelperBase<ExceptionHandlerVM> {
		...
		protected override string AddNewBeforeSelectionMessage => NetSpy_AsmEditor_Resources.EH_Command1;
		protected override string AddNewAfterSelectionMessage => NetSpy_AsmEditor_Resources.EH_Command2;
		protected override string AppendNewMessage => NetSpy_AsmEditor_Resources.EH_Command3;
		protected override string RemoveSingularMessage => NetSpy_AsmEditor_Resources.EH_Command4;
		protected override string RemovePluralMessage => NetSpy_AsmEditor_Resources.EH_Command5;
		protected override string RemoveAllMessage => NetSpy_AsmEditor_Resources.EH_Command6;
