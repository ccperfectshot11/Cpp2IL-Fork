...
namespace NetSpy.AsmEditor.MethodBody {
	...
	sealed class EditMethodBodyILCommand : IUndoCommand {
		...
		public string Description => NetSpy_AsmEditor_Resources.EditMethodBodyCommand2;
	...
	sealed class ReplaceILMethodBodyWithStub : IUndoCommand {
		...
		public string Description => NetSpy_AsmEditor_Resources.ReplaceMethodBodyWithStubCommand2;
