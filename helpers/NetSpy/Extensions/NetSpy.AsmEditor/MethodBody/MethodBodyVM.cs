...
namespace NetSpy.AsmEditor.MethodBody {
	sealed class MethodBodyVM : ViewModelBase {
		...
		internal static readonly EnumVM[] methodBodyTypeList = new EnumVM[] {
			new EnumVM(MethodBodyType.None, NetSpy_AsmEditor_Resources.MethodBodyType_None),
			new EnumVM(MethodBodyType.Cil, NetSpy_AsmEditor_Resources.MethodBodyType_IL),
			new EnumVM(MethodBodyType.Native, NetSpy_AsmEditor_Resources.MethodBodyType_Native),
		};
