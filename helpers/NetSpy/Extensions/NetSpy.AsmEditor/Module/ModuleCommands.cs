...
namespace NetSpy.AsmEditor.Module {
	[ExportAutoLoaded]
	...
	(nodes.Length == 0 || nodes.Any(a => a is DsDocumentNode));
		...
		public string Description => NetSpy_AsmEditor_Resources.CreateNetModuleCommand2;
	...
	sealed class ConvertNetModuleToAssemblyCommand : IUndoCommand {
		...
		public string Description => NetSpy_AsmEditor_Resources.ConvNetModuleToAssemblyCommand;
	...
	sealed class ConvertAssemblyToNetModuleCommand : IUndoCommand {
		...
		public string Description => NetSpy_AsmEditor_Resources.ConvAssemblyToNetModuleCommand;
	...
	sealed class AddNewNetModuleToAssemblyCommand : AddNetModuleToAssemblyCommand {
		...
		public override string Description => NetSpy_AsmEditor_Resources.AddNewNetModuleToAssemblyCommand2;
	}
	...
	sealed class AddExistingNetModuleToAssemblyCommand : AddNetModuleToAssemblyCommand {
		...
		static void Execute(Lazy<IUndoCommandService> undoCommandService, IAppService appService, IPickFilename pickFilename, DocumentTreeNodeData[] nodes) {
			...
			if (file.ModuleDef is null || file.AssemblyDef is not null || !(file is IDsDotNetDocument)) {
				MsgBox.Instance.Show(string.Format(NetSpy_AsmEditor_Resources.Error_NotNetModule, file.Filename), MsgBoxButton.OK);
		...
		public override string Description => NetSpy_AsmEditor_Resources.AddExistingNetModuleToAssemblyCommand2;
	}
	...
	sealed class RemoveNetModuleFromAssemblyCommand : IUndoCommand2 {
		...
		public string Description => NetSpy_AsmEditor_Resources.RemoveNetModuleCommand;
	...
	sealed class ModuleSettingsCommand : IUndoCommand {
		...
		public string Description => NetSpy_AsmEditor_Resources.EditModuleCommand2;
