...
namespace NetSpy.AsmEditor.Namespace {
	[ExportAutoLoaded]
	...
	sealed class DeleteNamespaceCommand : IUndoCommand {
		...
		static string GetCommandName(int count) =>
			count == 1 ?
			NetSpy_AsmEditor_Resources.DeleteNamespaceCommand :
			string.Format(NetSpy_AsmEditor_Resources.DeleteNamespacesCommand, count);
	...
	sealed class MoveNamespaceTypesToEmptypNamespaceCommand : IUndoCommand {
		...
		public string Description => NetSpy_AsmEditor_Resources.MoveTypesToEmptyNamespaceCommand;
	...
	sealed class RenameNamespaceCommand : IUndoCommand {
		...
		public string Description => NetSpy_AsmEditor_Resources.RenameNamespaceCommand;
