...
namespace NetSpy.AsmEditor.Property {
	[ExportAutoLoaded]
	...
	sealed class DeletePropertyDefCommand : IUndoCommand {
		...
		static string GetHeader(DocumentTreeNodeData[] nodes) {
			...
			return string.Format(NetSpy_AsmEditor_Resources.DeletePropertiesCommand, nodes.Length);
		}
		...
		public string Description => NetSpy_AsmEditor_Resources.DeletePropertyCommand;
	...
	sealed class CreatePropertyDefCommand : IUndoCommand {
		...
		static void Execute(Lazy<IUndoCommandService> undoCommandService, IAppService appService, DocumentTreeNodeData[] nodes) {
			...
			win.Title = NetSpy_AsmEditor_Resources.CreatePropertyCommand2;
		...
		public string Description => NetSpy_AsmEditor_Resources.CreatePropertyCommand2;
	...
	sealed class PropertyDefSettingsCommand : IUndoCommand {
		...
		public string Description => NetSpy_AsmEditor_Resources.EditPropertyCommand2;
