...
namespace NetSpy.AsmEditor.Resources {
	sealed class ImageListVM : ViewModelBase {
		...
		internal static readonly EnumVM[] colorDepthList = new EnumVM[] {
			new EnumVM(ColorDepth.Depth4Bit, NetSpy_AsmEditor_Resources.Resource_ColorDepth_4Bit),
			new EnumVM(ColorDepth.Depth8Bit, NetSpy_AsmEditor_Resources.Resource_ColorDepth_8Bit),
			new EnumVM(ColorDepth.Depth16Bit, NetSpy_AsmEditor_Resources.Resource_ColorDepth_16Bit),
			new EnumVM(ColorDepth.Depth24Bit, NetSpy_AsmEditor_Resources.Resource_ColorDepth_24Bit),
			new EnumVM(ColorDepth.Depth32Bit, NetSpy_AsmEditor_Resources.Resource_ColorDepth_32Bit),
		};
