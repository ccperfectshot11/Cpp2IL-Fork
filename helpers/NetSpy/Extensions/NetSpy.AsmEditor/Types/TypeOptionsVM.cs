...
namespace NetSpy.AsmEditor.Types {
	...
	sealed class TypeOptionsVM : ViewModelBase {
		...
		public string VisibilityAccessbilityText => IsNestedType ? NetSpy_AsmEditor_Resources.Type_Flags_Accessibility : NetSpy_AsmEditor_Resources.Type_Flags_Visibility;
		...
		public string BaseTypeHeader => string.Format(NetSpy_AsmEditor_Resources.BaseTypeX, TypeSigCreator.TypeSigDnlibFullName);
		...
		public TypeOptionsVM(TypeDefOptions options, ModuleDef ownerModule, IDecompilerService decompilerService, TypeDef? ownerType) {
			...
			InterfaceImplsVM = new TypeDefOrRefAndCAsVM<InterfaceImpl>(NetSpy_AsmEditor_Resources.EditInterfaceImpl, NetSpy_AsmEditor_Resources.CreateInterfaceImpl, ownerModule, decompilerService, ownerType, null);
