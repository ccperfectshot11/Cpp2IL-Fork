...
namespace NetSpy.Debugger.DotNet.CorDebug {
	[ExportExtension]
	sealed class TheExtension : IExtension {
		...
		public ExtensionInfo ExtensionInfo => new ExtensionInfo {
			ShortDescription = string.Format(NetSpy_Debugger_DotNet_CorDebug_Resources.Plugin_ShortDescription, ".NET Framework, .NET"),
		};
