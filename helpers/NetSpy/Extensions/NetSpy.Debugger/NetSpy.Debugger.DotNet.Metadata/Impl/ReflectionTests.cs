...
namespace NetSpy.Debugger.DotNet.Metadata.Impl {
	...
	public static class ReflectionTests {
		...
		2. Load some non-loaded asms in NetSpy's StartupClass.Main. This prevents some ResolveExceptions from being thrown
		...
		5. Debug NetSpy with VS
		6. Debug NetSpy with NetSpy, and when CPU usage is 0%, break the process
