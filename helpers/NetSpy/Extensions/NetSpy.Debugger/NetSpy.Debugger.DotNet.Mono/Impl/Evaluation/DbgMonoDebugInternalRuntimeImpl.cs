...
using NetSpy.Contracts.Debugger.DotNet.Disassembly;
...
using NetSpy.Debugger.DotNet.Mono.Impl.Evaluation.Hooks;
			...
			if (obj is null) {
				...
				if (field.IsLiteral) {
					...
					if (canNotAccessField)
						return (null, NetSpy_Debugger_DotNet_Mono_Resources.Error_CannotAccessMemberRuntimeLimitations);
