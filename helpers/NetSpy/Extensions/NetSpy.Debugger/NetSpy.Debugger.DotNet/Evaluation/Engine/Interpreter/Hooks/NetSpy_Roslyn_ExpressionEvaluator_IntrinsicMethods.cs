...
namespace NetSpy.Debugger.DotNet.Evaluation.Engine.Interpreter.Hooks {
	sealed class NetSpy_Roslyn_ExpressionEvaluator_IntrinsicMethods : DotNetClassHook {
		readonly IDebuggerRuntime runtime;

		public NetSpy_Roslyn_ExpressionEvaluator_IntrinsicMethods(IDebuggerRuntime runtime) => this.runtime = runtime;
