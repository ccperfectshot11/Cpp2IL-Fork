	...
	sealed class DbgEngineStepperImpl : DbgEngineStepper {
		...
		string GetStepFilterMessage(DmdMemberInfo member) {
			...
			case DmdPropertyInfo:
				return string.Format(NetSpy_Debugger_DotNet_Resources.StepFilter_SteppingOverProperty, memberName);

			case DmdMethodBase:
				return string.Format(NetSpy_Debugger_DotNet_Resources.StepFilter_SteppingOverOperator, memberName);
