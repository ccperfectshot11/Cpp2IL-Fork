...
namespace NetSpy.Debugger.Breakpoints.Code.TextEditor {
	sealed class BreakpointGlyphPopupVM : ViewModelBase {
		...
		public string SettingsToolTip => NetSpy_Debugger_Resources.Breakpoints_GlyphMargin_ShowSettingsToolTip;
		public string ToggleBreakpointToolTip => breakpoint.IsEnabled ? NetSpy_Debugger_Resources.Breakpoints_GlyphMargin_DisableBreakpoint : NetSpy_Debugger_Resources.Breakpoints_GlyphMargin_EnableBreakpoint;
