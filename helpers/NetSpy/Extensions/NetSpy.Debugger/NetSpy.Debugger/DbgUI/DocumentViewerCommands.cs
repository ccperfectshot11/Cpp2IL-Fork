	...
	static class DocumentViewerCommands {
		...
		sealed class DebugProgramDocumentViewerCommand : DocumentViewerCommand {
			...
			public override string? GetHeader(Context context) {
				...
				return string.Format(NetSpy_Debugger_Resources.DebugProgramX, UIUtilities.EscapeMenuItemHeader(Path.GetFileName(filename)));
			}
		...
		sealed class ToggleCreateBreakpointDocumentViewerCommand : DocumentViewerCommand {
			...
			public override string? GetHeader(Context context) {
				...
				case ToggleCreateBreakpointKind.Add:	return NetSpy_Debugger_Resources.AddBreakpointCommand;
				case ToggleCreateBreakpointKind.Delete:	return NetSpy_Debugger_Resources.DeleteBreakpointCommand;
				case ToggleCreateBreakpointKind.Enable:	return NetSpy_Debugger_Resources.EnableBreakpointCommand;
		...
		sealed class ToggleEnableBreakpointDocumentViewerCommand : DocumentViewerCommand {
			...
			public override string? GetHeader(Context context) {
				...
				case ToggleEnableBreakpointKind.Enable:	return NetSpy_Debugger_Resources.EnableBreakpointCommand2;
				case ToggleEnableBreakpointKind.Disable:return NetSpy_Debugger_Resources.DisableBreakpointCommand2;
