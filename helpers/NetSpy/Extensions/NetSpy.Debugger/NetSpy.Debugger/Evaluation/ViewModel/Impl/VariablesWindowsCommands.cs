...
namespace NetSpy.Debugger.Evaluation.ViewModel.Impl {
	...
	sealed class EditValueVariablesWindowCtxMenuCommand : VariablesWindowCtxMenuCommand {
		...
		public override string? GetInputGestureText(VariablesWindowCtxMenuContext context) {
			...
			case VariablesWindowKind.Locals: return NetSpy_Debugger_Resources.ShortCutKeyF2;
			case VariablesWindowKind.Autos: return NetSpy_Debugger_Resources.ShortCutKeyF2;
			case VariablesWindowKind.StaticFields: return NetSpy_Debugger_Resources.ShortCutKeyF2;
