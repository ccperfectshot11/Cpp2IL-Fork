...
namespace NetSpy.Debugger.ToolWindows.CallStack {
	...
	sealed class ToggleBreakpointCallStackCtxMenuCommand : CallStackCtxMenuCommand {
		...
		public override bool IsVisible(CallStackCtxMenuContext context) => context.Operations.BreakpointsCommandKind == BreakpointsCommandKind.Edit;
		public override string? GetHeader(CallStackCtxMenuContext context) => context.Operations.IsBreakpointEnabled ? NetSpy_Debugger_Resources.DisableBreakpointCommand2 : NetSpy_Debugger_Resources.EnableBreakpointCommand2;
	}
