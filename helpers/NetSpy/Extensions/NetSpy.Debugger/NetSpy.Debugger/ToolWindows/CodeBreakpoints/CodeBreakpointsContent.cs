...
namespace NetSpy.Debugger.ToolWindows.CodeBreakpoints {
	...
	sealed class CodeBreakpointsContent : ICodeBreakpointsContent {
		...
		sealed class ControlVM : ViewModelBase {
			...
			public string RemoveCodeBreakpointToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Breakpoints_RemoveBreakpoint_ToolTip, null);
			public string RemoveMatchingBreakpointsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Breakpoints_RemoveMatchingBreakpoints_ToolTip, null);
			public string ToggleMatchingBreakpointsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Breakpoints_ToggleMatchingBreakpoints_ToolTip, null);
			public string ExportMatchingBreakpointsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Breakpoints_ExportMatchingBreakpoints_ToolTip, null);
			public string ImportBreakpointsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Breakpoints_ImportBreakpoints_ToolTip, null);
			public string GoToSourceCodeToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Breakpoints_GoToSourceCode_ToolTip, null);
			public string GoToDisassemblyToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Breakpoints_GoToDisassembly_ToolTip, null);
			public string SearchToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Breakpoints_Search_ToolTip, NetSpy_Debugger_Resources.ShortCutKeyCtrlF);
			public string ResetSearchSettingsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Breakpoints_ResetSearchSettings_ToolTip, null);
