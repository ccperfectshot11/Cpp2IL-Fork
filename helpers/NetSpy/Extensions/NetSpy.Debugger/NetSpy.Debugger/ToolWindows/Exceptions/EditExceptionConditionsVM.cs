...
namespace NetSpy.Debugger.ToolWindows.Exceptions {
	sealed class ExceptionConditionVM : ViewModelBase {
		...
		static readonly ConditionTypeVM[] conditionTypes = new ConditionTypeVM[] {
			new ConditionTypeVM(DbgExceptionConditionType.ModuleNameEquals, NetSpy_Debugger_Resources.Exception_Conditions_ModuleNameEquals),
			new ConditionTypeVM(DbgExceptionConditionType.ModuleNameNotEquals, NetSpy_Debugger_Resources.Exception_Conditions_ModuleNameNotEquals),
		};
