...
namespace NetSpy.Debugger.ToolWindows.Exceptions {
	...
	sealed class ExceptionsContent : IExceptionsContent {
		...
		sealed class ControlVM : ViewModelBase {
			...
			public string ShowOnlyEnabledExceptionsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Exceptions_ShowOnlyEnabledExceptions_ToolTip, null);
			public string AddExceptionToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Exceptions_Add_ToolTip, null);
			public string RemoveExceptionsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Exceptions_Remove_ToolTip, null);
			public string ToggleMatchingExceptionsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Exceptions_ToggleMatchingExceptions_ToolTip, null);
			public string EditConditionsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Exceptions_EditConditions_ToolTip, null);
			public string RestoreSettingsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Exceptions_RestoreSettings_ToolTip, null);
			public string ResetSearchSettingsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Exceptions_ResetSearchSettings_ToolTip, null);
			public string SearchToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Exceptions_Search_ToolTip, NetSpy_Debugger_Resources.ShortCutKeyCtrlF);
