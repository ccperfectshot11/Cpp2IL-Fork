...
namespace NetSpy.Debugger.ToolWindows.ModuleBreakpoints {
	...
	sealed class EditOrderBreakpointCtxMenuCommand : ModuleBreakpointsCtxMenuCommand {
		...
		public override string? GetInputGestureText(ModuleBreakpointsCtxMenuContext context) => string.Format(NetSpy_Debugger_Resources.ShortCutKeyCtrl_DIGIT, "2");
	}
	...
	sealed class EditProcessNameBreakpointCtxMenuCommand : ModuleBreakpointsCtxMenuCommand {
		...
		public override string? GetInputGestureText(ModuleBreakpointsCtxMenuContext context) => string.Format(NetSpy_Debugger_Resources.ShortCutKeyCtrl_DIGIT, "3");
	}
	...
	sealed class EditAppDomainNameBreakpointCtxMenuCommand : ModuleBreakpointsCtxMenuCommand {
		...
		public override string? GetInputGestureText(ModuleBreakpointsCtxMenuContext context) => string.Format(NetSpy_Debugger_Resources.ShortCutKeyCtrl_DIGIT, "4");
	}
