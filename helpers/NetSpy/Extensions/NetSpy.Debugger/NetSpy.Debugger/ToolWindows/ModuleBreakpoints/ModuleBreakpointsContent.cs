...
namespace NetSpy.Debugger.ToolWindows.ModuleBreakpoints {
	...
	sealed class ModuleBreakpointsContent : IModuleBreakpointsContent {
		...
		sealed class ControlVM : ViewModelBase {
			...
			public string AddModuleBreakpointToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Breakpoints_AddBreakpoint_ToolTip, null);
			public string RemoveModuleBreakpointToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Breakpoints_RemoveBreakpoint_ToolTip, null);
