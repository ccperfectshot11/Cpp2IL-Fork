...
namespace NetSpy.Debugger.ToolWindows.Modules {
	...
	sealed class ModulesContent : IModulesContent {
		...
		sealed class ControlVM : ViewModelBase {
			...
			public string SearchToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Modules_Search_ToolTip, NetSpy_Debugger_Resources.ShortCutKeyCtrlF);
			public string ResetSearchSettingsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Modules_ResetSearchSettings_ToolTip, null);
