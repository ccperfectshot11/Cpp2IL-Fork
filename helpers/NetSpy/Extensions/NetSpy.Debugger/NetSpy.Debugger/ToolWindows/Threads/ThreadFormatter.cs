...
namespace NetSpy.Debugger.ToolWindows.Threads {
	...
	sealed class ThreadFormatter {
		...
		public void WritePriority(IDbgTextWriter output, ThreadVM vm) {
			switch (vm.Priority) {
			case ThreadPriority.Lowest:			output.Write(DbgTextColor.EnumField, NetSpy_Debugger_Resources.Thread_Priority_Lowest); break;
			case ThreadPriority.BelowNormal:	output.Write(DbgTextColor.EnumField, NetSpy_Debugger_Resources.Thread_Priority_BelowNormal); break;
			case ThreadPriority.Normal:			output.Write(DbgTextColor.EnumField, NetSpy_Debugger_Resources.Thread_Priority_Normal); break;
			case ThreadPriority.AboveNormal:	output.Write(DbgTextColor.EnumField, NetSpy_Debugger_Resources.Thread_Priority_AboveNormal); break;
			case ThreadPriority.Highest:		output.Write(DbgTextColor.EnumField, NetSpy_Debugger_Resources.Thread_Priority_Highest); break;
