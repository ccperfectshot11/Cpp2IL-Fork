...
namespace NetSpy.Debugger.ToolWindows.Threads {
	...
	sealed class ThreadsContent : IThreadsContent {
		...
		sealed class ControlVM : ViewModelBase {
			...
			public string FreezeThreadsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Threads_FreezeThreads_ToolTip, null);
			public string ThawThreadsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Threads_ThawThreads_ToolTip, null);
			public string SearchToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Threads_Search_ToolTip, NetSpy_Debugger_Resources.ShortCutKeyCtrlF);
			public string ResetSearchSettingsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Debugger_Resources.Threads_ResetSearchSettings_ToolTip, null);
