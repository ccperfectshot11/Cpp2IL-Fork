...
namespace de4dot.blocks.cflow {
	public class InstructionEmulator {
        ...
        void Emulate_Newarr(Instruction instr)
        {
            ...
            // Value must be non-negative: a negative size still satisfies "< 500000" and
            // would throw ArgumentOutOfRangeException in the List constructor, aborting the
            // whole deobfuscation. Obfuscated native predicates can produce bogus sizes.
