...
using NetSpy.Contracts.Scripting.Roslyn;
...
using NetSpy.Roslyn.Text.Classification;
...
namespace NetSpy.Scripting.Roslyn.Common {
	...
	abstract class ScriptControlVM : ViewModelBase, IReplCommandHandler, IScriptGlobalsHelper {
		...
		static readonly string TEXTFILES_FILTER = $"{NetSpy_Scripting_Roslyn_Resources.TextFiles} (*.txt)|*.txt|{NetSpy_Scripting_Roslyn_Resources.AllFiles} (*.*)|*.*";
		...
		public string ResetToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Scripting_Roslyn_Resources.Script_ToolTip_Reset, null);
		public string ClearScreenToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Scripting_Roslyn_Resources.Script_ToolTip_ClearScreen, NetSpy_Scripting_Roslyn_Resources.ShortCutKeyCtrlL);
		public string HistoryPreviousToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Scripting_Roslyn_Resources.Script_ToolTip_HistoryPrevious, NetSpy_Scripting_Roslyn_Resources.ShortCutKeyAltUp);
		public string HistoryNextToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Scripting_Roslyn_Resources.Script_ToolTip_HistoryNext, NetSpy_Scripting_Roslyn_Resources.ShortCutKeyAltDown);
		public string SaveToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Scripting_Roslyn_Resources.Repl_Save_ToolTip, NetSpy_Scripting_Roslyn_Resources.ShortCutKeyCtrlS);
		public string WordWrapToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Scripting_Roslyn_Resources.Repl_WordWrap_ToolTip, NetSpy_Scripting_Roslyn_Resources.ShortCutKeyCtrlECtrlW);
		...
		public void Reset(bool loadConfig = true) {
			...
			ReplEditor.Reset();
			isResetting = false;
			ReplEditor.OutputPrintLine(NetSpy_Scripting_Roslyn_Resources.ResettingExecutionEngine, BoxedTextColor.ReplOutputText);
		...
		void PrintDiagnostics(ImmutableArray<Diagnostic> diagnostics) {
			...
			if (extraErrors > 0) {
				if (extraErrors == 1)
					ReplEditor.OutputPrintLine(string.Format(NetSpy_Scripting_Roslyn_Resources.CompilationAdditionalError, extraErrors), BoxedTextColor.Error, true);
				else
					ReplEditor.OutputPrintLine(string.Format(NetSpy_Scripting_Roslyn_Resources.CompilationAdditionalErrors, extraErrors), BoxedTextColor.Error, true);
			}
		}
