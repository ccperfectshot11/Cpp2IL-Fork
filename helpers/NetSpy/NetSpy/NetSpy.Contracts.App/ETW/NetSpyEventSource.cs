...
namespace NetSpy.Contracts.ETW {
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
	[EventSource(Name = "NetSpy")]
	public sealed class NetSpyEventSource : EventSource {
		public static readonly NetSpyEventSource Log = new NetSpyEventSource();
		NetSpyEventSource() { }
