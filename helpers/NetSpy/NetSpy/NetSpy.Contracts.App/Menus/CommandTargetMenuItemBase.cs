...
namespace NetSpy.Contracts.Menus {
	/// <summary>
	...
	public abstract class CommandTargetMenuItemBase : MenuItemBase {
		...
		/// <inheritdoc/>
		public override bool IsVisible(IMenuItemContext context) => GetCommandTarget(context) is not null;
	...
	public abstract class CommandTargetMenuItemBase<TContext> : MenuItemBase<TContext> where TContext : class {
		...
		/// <inheritdoc/>
		public override bool IsVisible(TContext context) => GetCommandTarget(context) is not null;
