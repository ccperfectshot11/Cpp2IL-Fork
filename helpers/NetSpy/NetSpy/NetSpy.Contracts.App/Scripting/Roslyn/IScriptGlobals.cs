...
namespace NetSpy.Contracts.Scripting.Roslyn {
	/// <summary>
	...
	public interface IScriptGlobals : ITextPrinter {
		...
		/// <summary>
		/// Calls <see cref="System.Diagnostics.Debugger.Break"/>. Use NetSpy to debug itself
		/// (NetSpy --multiple) and then call this method from your script in the debugged NetSpy process.
		/// </summary>
		void Break();
