...
namespace NetSpy.Contracts.Text {
	/// <summary>
	/// Content types
	/// </summary>
	public static class ContentTypes {
		...
		/// <summary>
		/// Disassembled BAML (NetSpy BAML extension)
		/// </summary>
		public const string BamlNetSpy = "BAML-NetSpy";
		...
		/// About NetSpy
		/// </summary>
		public const string AboutNetSpy = "About NetSpy";
