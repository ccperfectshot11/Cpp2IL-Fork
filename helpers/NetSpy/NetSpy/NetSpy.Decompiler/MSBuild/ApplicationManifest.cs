...
namespace NetSpy.Decompiler.MSBuild {
	sealed class ApplicationManifest : IFileJob {
		...
		public string Description => NetSpy_Decompiler_Resources.MSBuild_CreateAppManifest;
	...
	sealed class ApplicationManifestProjectFile : ProjectFile {
		...
		public override string Description => NetSpy_Decompiler_Resources.MSBuild_CreateAppManifest;
