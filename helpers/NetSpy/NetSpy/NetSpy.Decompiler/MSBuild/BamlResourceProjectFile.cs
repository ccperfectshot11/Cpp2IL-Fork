...
namespace NetSpy.Decompiler.MSBuild {
	sealed class BamlResourceProjectFile : ProjectFile {
		public override string Description => NetSpy_Decompiler_Resources.MSBuild_DecompileBaml;
	...
	sealed class AppBamlResourceProjectFile : ProjectFile {
		public override string Description => NetSpy_Decompiler_Resources.MSBuild_CreateAppXaml;
