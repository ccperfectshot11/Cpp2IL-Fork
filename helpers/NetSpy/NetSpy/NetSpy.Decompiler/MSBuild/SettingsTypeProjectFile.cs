...
namespace NetSpy.Decompiler.MSBuild {
	sealed class SettingsTypeProjectFile : TypeProjectFile {
		public override string Description => NetSpy_Decompiler_Resources.MSBuild_CreateSettingsTypeFile;
	...
	sealed class SettingsDesignerTypeProjectFile : ProjectFile {
		public override string Description => NetSpy_Decompiler_Resources.MSBuild_CreateSettingsDesignerTypeFile;
