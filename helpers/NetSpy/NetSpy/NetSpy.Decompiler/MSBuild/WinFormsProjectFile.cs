...
namespace NetSpy.Decompiler.MSBuild {
	sealed class WinFormsProjectFile : TypeProjectFile {
		public override string Description => NetSpy_Decompiler_Resources.MSBuild_CreateWinFormsFile;
	...
	sealed class WinFormsDesignerProjectFile : ProjectFile {
		public override string Description => NetSpy_Decompiler_Resources.MSBuild_CreateWinFormsDesignerFile;
