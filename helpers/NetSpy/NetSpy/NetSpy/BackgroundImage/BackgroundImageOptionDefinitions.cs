...
namespace NetSpy.BackgroundImage {
	static class BackgroundImageOptionDefinitions {
		...
		sealed class Default : IBackgroundImageOptionDefinition {
			...
			public string DisplayName => NetSpy_Resources.BgImgDisplayName_Default;
		...
		sealed class DocumentViewer : IBackgroundImageOptionDefinition {
			...
			public string DisplayName => NetSpy_Resources.BgImgDisplayName_DocumentViewer;
		...
		sealed class Repl : IBackgroundImageOptionDefinition {
			...
			public string DisplayName => NetSpy_Resources.BgImgDisplayName_REPL;
		...
		sealed class CodeEditor : IBackgroundImageOptionDefinition {
			...
			public string DisplayName => NetSpy_Resources.BgImgDisplayName_CodeEditor;
		...
		sealed class Logger : IBackgroundImageOptionDefinition {
			...
			public string DisplayName => NetSpy_Resources.BgImgDisplayName_Logger;
		...
		sealed class HexEditor : IBackgroundImageOptionDefinition {
			...
			public string DisplayName => NetSpy_Resources.BgImgDisplayName_HexEditor;
