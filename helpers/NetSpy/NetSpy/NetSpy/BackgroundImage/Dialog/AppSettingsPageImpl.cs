...
namespace NetSpy.BackgroundImage.Dialog {
	...
	sealed class AppSettingsPageImpl : AppSettingsPage {
		...
		public override string Title => NetSpy_Resources.BackgroundImageOptDlgTab;
		...
		static readonly EnumVM[] stretchDirectionList = new EnumVM[] {
			new EnumVM(StretchDirection.Both, NetSpy_Resources.StretchDirection_Both),
			new EnumVM(StretchDirection.UpOnly, NetSpy_Resources.StretchDirection_UpOnly),
			new EnumVM(StretchDirection.DownOnly, NetSpy_Resources.StretchDirection_DownOnly),
		};
		...
		static readonly EnumVM[] imagePlacementList = new EnumVM[] {
			new EnumVM(ImagePlacement.TopLeft, NetSpy_Resources.ImagePlacement_TopLeft),
			new EnumVM(ImagePlacement.TopRight, NetSpy_Resources.ImagePlacement_TopRight),
			new EnumVM(ImagePlacement.BottomLeft, NetSpy_Resources.ImagePlacement_BottomLeft),
			new EnumVM(ImagePlacement.BottomRight, NetSpy_Resources.ImagePlacement_BottomRight),
			new EnumVM(ImagePlacement.Top, NetSpy_Resources.ImagePlacement_Top),
			new EnumVM(ImagePlacement.Left, NetSpy_Resources.ImagePlacement_Left),
			new EnumVM(ImagePlacement.Right, NetSpy_Resources.ImagePlacement_Right),
			new EnumVM(ImagePlacement.Bottom, NetSpy_Resources.ImagePlacement_Bottom),
			new EnumVM(ImagePlacement.Center, NetSpy_Resources.ImagePlacement_Center),
		};
...
#pragma warning restore CS8618 // Non-nullable field is uninitialized.
		...
		static readonly string ImagesFilter = $"{NetSpy_Resources.Files_Images}|*.png;*.gif;*.bmp;*.jpg;*.jpeg|{NetSpy_Resources.AllFiles} (*.*)|*.*";
