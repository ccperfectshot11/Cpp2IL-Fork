...
namespace NetSpy.Bookmarks.Commands {
	static class AppMenuCommands {
		...
		sealed class EnableAllBookmarksCommand : MenuItemBase {
			...
			public override string? GetHeader(IMenuItemContext context) {
				...
				case EnableAllBookmarksKind.Enable:		return NetSpy_Resources.EnableAllBookmarksCommand;
				case EnableAllBookmarksKind.Disable:	return NetSpy_Resources.DisableAllBookmarksCommand;
				default:								return null;
				}
			}
		}
