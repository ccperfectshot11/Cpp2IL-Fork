...
namespace NetSpy.Bookmarks.ToolWindows.Bookmarks {
	...
	sealed class BookmarksContent : IBookmarksContent {
		...
		sealed class ControlVM : ViewModelBase {
			...
			public string ToggleCreateBookmarkToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_ToggleCreateBookmark_ToolTip, null);
			public string GoToPreviousBookmarkToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_GoToPreviousBookmark_ToolTip, null);
			public string GoToNextBookmarkToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_GoToNextBookmark_ToolTip, null);
			public string GoToPreviousBookmarkSameLabelToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_GoToPreviousBookmarkSameLabel_ToolTip, null);
			public string GoToNextBookmarkSameLabelToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_GoToNextBookmarkSameLabel_ToolTip, null);
			public string GoToPreviousBookmarkInFileToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_GoToPreviousBookmarkInFile_ToolTip, null);
			public string GoToNextBookmarkInFileToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_GoToNextBookmarkInFile_ToolTip, null);

			public string RemoveBookmarkToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_RemoveBookmark_ToolTip, null);
			public string RemoveMatchingBookmarksToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_RemoveMatchingBookmarks_ToolTip, null);
			public string ToggleMatchingBookmarksToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_ToggleMatchingBookmarks_ToolTip, null);
			public string ExportMatchingBookmarksToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_ExportMatchingBookmarks_ToolTip, null);
			public string ImportBookmarksToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_ImportBookmarks_ToolTip, null);
			public string GoToLocationToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_GoToLocation_ToolTip, null);
			public string SearchToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_Search_ToolTip, NetSpy_Resources.ShortCutKeyCtrlF);
			public string ResetSearchSettingsToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.Bookmarks_ResetSearchSettings_ToolTip, null);
			public string SearchHelpToolTip => ToolTipHelper.AddKeyboardShortcut(NetSpy_Resources.SearchHelp_ToolTip, null);
