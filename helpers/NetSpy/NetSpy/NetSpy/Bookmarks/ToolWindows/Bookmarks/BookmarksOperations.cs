	...
	sealed class BookmarksOperationsImpl : BookmarksOperations {
		...
		public override void EditLabels() {
			...
			if (SelectedItems.Count == 1)
				...
				var newLabels = messageBoxService.Ask<string>(NetSpy_Resources.EditLabelsMsgBoxLabel, SelectedItems[0].GetLabelsString(), NetSpy_Resources.EditLabelsTitle);
