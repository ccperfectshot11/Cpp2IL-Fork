...
namespace NetSpy.Documents.Tabs.Settings {
	...
	sealed class AssemblyExplorerAppSettingsPage : AppSettingsPage, IAppSettingsPage2 {
		...
		public override string Title => NetSpy_Resources.AssemblyExplorerTitle;
		...
		static string ToString(MemberKind o) {
			switch (o) {
			case MemberKind.NestedTypes:	return NetSpy_Resources.MemberKind_NestedTypes;
			case MemberKind.Fields:			return NetSpy_Resources.MemberKind_Fields;
			case MemberKind.Events:			return NetSpy_Resources.MemberKind_Events;
			case MemberKind.Properties:		return NetSpy_Resources.MemberKind_Properties;
			case MemberKind.Methods:		return NetSpy_Resources.MemberKind_Methods;
			default:
		...
		static string ToString(DocumentFilterType o) {
			switch (o) {
			case DocumentFilterType.All:			return NetSpy_Resources.DocumentFilterType_All;
			case DocumentFilterType.AllSupported:	return NetSpy_Resources.DocumentFilterType_AllSupported;
			case DocumentFilterType.DotNetOnly:		return NetSpy_Resources.DocumentFilterType_DotNetOnly;
			default:
				Debug.Fail("Shouldn't be here");
				return "???";
			}
