...
namespace NetSpy.Documents.TreeView {
	sealed class TypeReferencesFolderNodeImpl : TypeReferencesFolderNode {
		...
		protected override void WriteCore(ITextColorWriter output, IDecompiler decompiler, DocumentNodeWriteOptions options) {
			output.Write(BoxedTextColor.Text, NetSpy_Resources.TypeReferencesFolder);
	...
	sealed class TypeSpecsFolderNodeImpl : TypeSpecsFolderNode {
		...
		protected override void WriteCore(ITextColorWriter output, IDecompiler decompiler, DocumentNodeWriteOptions options) {
			output.Write(BoxedTextColor.Text, NetSpy_Resources.TreeViewTypesFolder);
			if ((options & DocumentNodeWriteOptions.ToolTip) != 0) {
				output.WriteLine();
	...
	sealed class MethodReferencesFolderNodeImpl : MethodReferencesFolderNode {
		...
		protected override void WriteCore(ITextColorWriter output, IDecompiler decompiler, DocumentNodeWriteOptions options) {
			output.Write(BoxedTextColor.Text, NetSpy_Resources.TreeViewMethodsFolder);
			if ((options & DocumentNodeWriteOptions.ToolTip) != 0) {
				output.WriteLine();
				WriteScope(output, scope);
			}
	...
	sealed class PropertyReferencesFolderNodeImpl : PropertyReferencesFolderNode {
		...
		protected override void WriteCore(ITextColorWriter output, IDecompiler decompiler, DocumentNodeWriteOptions options) {
			output.Write(BoxedTextColor.Text, NetSpy_Resources.TreeViewPropertiesFolder);
			if ((options & DocumentNodeWriteOptions.ToolTip) != 0) {
				output.WriteLine();
				WriteScope(output, scope);
			}
	...
	sealed class EventReferencesFolderNodeImpl : EventReferencesFolderNode {
		...
		protected override void WriteCore(ITextColorWriter output, IDecompiler decompiler, DocumentNodeWriteOptions options) {
			output.Write(BoxedTextColor.Text, NetSpy_Resources.TreeViewEventsFolder);
			if ((options & DocumentNodeWriteOptions.ToolTip) != 0) {
				output.WriteLine();
				WriteScope(output, scope);
			}
	...
	sealed class FieldReferencesFolderNodeImpl : FieldReferencesFolderNode {
		...
		protected override void WriteCore(ITextColorWriter output, IDecompiler decompiler, DocumentNodeWriteOptions options) {
			output.Write(BoxedTextColor.Text, NetSpy_Resources.TreeViewFieldsFolder);
			if ((options & DocumentNodeWriteOptions.ToolTip) != 0) {
				output.WriteLine();
				WriteScope(output, scope);
			}
