...
namespace NetSpy.Hex.Commands {
	sealed class GoToMetadataVM : ViewModelBase {
		...
		public GoToMetadataVM(HexBuffer buffer, DotNetMetadataHeaders mdHeaders, PeHeaders? peHeaders, uint value) {
			...
			GoToMetadataCollection.Add(new GoToMetadataKindVM(GoToMetadataKind.Table, NetSpy_Resources.GoToMetadataToken, NetSpy_Resources.ShortCutKeyCtrl1));
			if (peHeaders is not null)
				GoToMetadataCollection.Add(new GoToMetadataKindVM(GoToMetadataKind.MemberRva, NetSpy_Resources.GoToMetadataMethodBody, NetSpy_Resources.ShortCutKeyCtrl2));
			GoToMetadataCollection.Add(new GoToMetadataKindVM(GoToMetadataKind.Blob, "#Blob", NetSpy_Resources.ShortCutKeyCtrl3));
			GoToMetadataCollection.Add(new GoToMetadataKindVM(GoToMetadataKind.Strings, "#Strings", NetSpy_Resources.ShortCutKeyCtrl4));
			GoToMetadataCollection.Add(new GoToMetadataKindVM(GoToMetadataKind.US, "#US", NetSpy_Resources.ShortCutKeyCtrl5));
			GoToMetadataCollection.Add(new GoToMetadataKindVM(GoToMetadataKind.GUID, "#GUID", NetSpy_Resources.ShortCutKeyCtrl6));
		...
		sealed class OffsetTokenVM : NumberDataFieldVM<uint, uint> {
			...
			protected override string? ConvertToValue(out uint value) {
				...
				if (error is not null)
					return error;
				return CheckOffsetToken(value) ? null : NetSpy_Resources.GoToMetadataInvalidOffsetOrToken;
			}
