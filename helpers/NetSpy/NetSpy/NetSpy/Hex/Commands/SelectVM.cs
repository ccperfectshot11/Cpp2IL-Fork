...
namespace NetSpy.Hex.Commands {
	sealed class SelectVM : ViewModelBase {
		...
		public SelectVM(HexPosition start, HexPosition end) {
			...
			PositionsCollection.Add(new PositionVM(PositionKind.Absolute, NetSpy_Resources.GoToAbsolutePosition, NetSpy_Resources.ShortCutKeyCtrl1));
			PositionsCollection.Add(new PositionVM(PositionKind.File, NetSpy_Resources.GoToFilePosition, NetSpy_Resources.ShortCutKeyCtrl2));
			PositionsCollection.Add(new PositionVM(PositionKind.RVA, "RVA", NetSpy_Resources.ShortCutKeyCtrl3));
			PositionsCollection.Add(new PositionVM(PositionKind.CurrentPosition, NetSpy_Resources.GoToCurrentPosition, NetSpy_Resources.ShortCutKeyCtrl4));
			positionsCollectionSelectedItem = PositionsCollection[0];
			PositionLengthCollection = new ObservableCollection<PositionLengthVM>();
			PositionLengthCollection.Add(new PositionLengthVM(SelectPositionLengthKind.Position, NetSpy_Resources.GoToAbsolutePosition, NetSpy_Resources.ShortCutKeyCtrlO));
			PositionLengthCollection.Add(new PositionLengthVM(SelectPositionLengthKind.Length, NetSpy_Resources.SelectLength, NetSpy_Resources.ShortCutKeyCtrlL));
