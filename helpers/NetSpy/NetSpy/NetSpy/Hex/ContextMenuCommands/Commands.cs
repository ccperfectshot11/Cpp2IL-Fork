...
using NetSpy.Hex.Commands;
using NetSpy.Properties;

namespace NetSpy.Hex.ContextMenuCommands {
	...
	sealed class DeleteContextMenuEntry : HexViewCommandTargetMenuItemBase {
		...
		public override string? GetHeader(HexViewContext context) => !context.HexView.Selection.IsEmpty ? NetSpy_Resources.ClearSelectedBytesCommand : NetSpy_Resources.ClearByteCommand;
	}
	...
	sealed class BytesPerLineSubContextMenuEntry : HexViewCommandTargetMenuItemBase2, IMenuItemProvider {
		...
		static readonly (int bits, string header)[] subMenus = new (int, string)[] {
			(0, NetSpy_Resources.HexEditor_BytesPerLine_FitToWidth),
			(8, NetSpy_Resources.HexEditor_BytesPerLine_8),
			(16, NetSpy_Resources.HexEditor_BytesPerLine_16),
			(32, NetSpy_Resources.HexEditor_BytesPerLine_32),
			(48, NetSpy_Resources.HexEditor_BytesPerLine_48),
			(64, NetSpy_Resources.HexEditor_BytesPerLine_64),
		};
	...
	sealed class CopyUInt16ContextMenuEntry : HexViewCommandTargetMenuItemBase {
		...
		public override string? GetHeader(HexViewContext context) => string.Format(NetSpy_Resources.CopyDataCommand, "UInt16");
	}
	...
	sealed class CopyUInt16BigEndianContextMenuEntry : HexViewCommandTargetMenuItemBase {
		...
		public override string? GetHeader(HexViewContext context) => string.Format(NetSpy_Resources.CopyDataCommand, "UInt16" + " (" + NetSpy_Resources.BigEndian + ")");
	}
	...
	sealed class CopyUInt32ContextMenuEntry : HexViewCommandTargetMenuItemBase {
		...
		public override string? GetHeader(HexViewContext context) => string.Format(NetSpy_Resources.CopyDataCommand, "UInt32");
	}
	...
	sealed class CopyUInt32BigEndianContextMenuEntry : HexViewCommandTargetMenuItemBase {
		...
		public override string? GetHeader(HexViewContext context) => string.Format(NetSpy_Resources.CopyDataCommand, "UInt32" + " (" + NetSpy_Resources.BigEndian + ")");
	}
	...
	sealed class CopyUInt64ContextMenuEntry : HexViewCommandTargetMenuItemBase {
		...
		public override string? GetHeader(HexViewContext context) => string.Format(NetSpy_Resources.CopyDataCommand, "UInt64");
	}
	...
	sealed class CopyUInt64BigEndianContextMenuEntry : HexViewCommandTargetMenuItemBase {
		...
		public override string? GetHeader(HexViewContext context) => string.Format(NetSpy_Resources.CopyDataCommand, "UInt64" + " (" + NetSpy_Resources.BigEndian + ")");
	}
