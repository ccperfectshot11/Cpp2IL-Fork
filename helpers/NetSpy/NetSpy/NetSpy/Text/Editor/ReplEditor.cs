...
using NetSpy.Contracts.Text.Editor.Operations;
using NetSpy.Contracts.Text.Editor.OptionsExtensionMethods;
using NetSpy.Contracts.Text.Operations;
using NetSpy.Text.Operations;
