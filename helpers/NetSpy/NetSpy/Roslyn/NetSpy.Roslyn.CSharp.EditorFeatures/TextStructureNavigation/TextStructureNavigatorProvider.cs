...
using NetSpy.Roslyn.EditorFeatures.Editor;
using NetSpy.Roslyn.EditorFeatures.Host;
using NetSpy.Roslyn.EditorFeatures.TextStructureNavigation;
...
namespace NetSpy.Roslyn.CSharp.EditorFeatures.TextStructureNavigation {
