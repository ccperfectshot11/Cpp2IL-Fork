...
using NetSpy.Contracts.Debugger.Breakpoints.Code.FilterExpressionEvaluator;
...
namespace NetSpy.Roslyn.Debugger.FilterExpressionEvaluator {
	...
	sealed class DbgFilterExpressionEvaluatorImpl : DbgFilterExpressionEvaluator {
		...
		public override DbgFilterExpressionEvaluatorResult Evaluate(string expr, DbgFilterEEVariableProvider variableProvider) {
			...
			try {
				...
				compiledExpr.RuntimeError = string.Format(NetSpy_Roslyn_Resources.FilterExpressionEvaluator_CompiledExpressionThrewAnException, ex.GetType().FullName);
				return new DbgFilterExpressionEvaluatorResult(compiledExpr.RuntimeError);
			}
		...
		CompiledExpr CreateCompiledExpr(string expr) {
			...
			return new CompiledExpr(NetSpy_Roslyn_Resources.FilterExpressionEvaluator_InvalidExpression);
		}
