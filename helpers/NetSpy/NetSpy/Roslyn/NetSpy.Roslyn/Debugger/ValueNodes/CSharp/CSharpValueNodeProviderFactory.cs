...
namespace NetSpy.Roslyn.Debugger.ValueNodes.CSharp {
	sealed class CSharpValueNodeProviderFactory : DbgDotNetValueNodeProviderFactory {
		...
		readonly DbgDotNetText staticMembersName = new DbgDotNetText(new DbgDotNetTextPart(DbgTextColor.Text, NetSpy_Roslyn_Resources.DebuggerVarsWindow_CSharp_StaticMembers));
