...
namespace NetSpy.Roslyn.Debugger.ValueNodes {
	sealed class DbgDotNetTypeVariablesNode : DbgDotNetValueNode {
		...
		static readonly DbgDotNetText typeVariablesName = new DbgDotNetText(new DbgDotNetTextPart(DbgTextColor.Text, NetSpy_Roslyn_Resources.LocalsWindow_TypeVariables));
