...
namespace NetSpy.Roslyn.Debugger.ValueNodes {
	abstract class MembersValueNodeProvider : DbgDotNetValueNodeProvider {
		...
		static readonly DbgDotNetText errorPropertyName = new DbgDotNetText(new DbgDotNetTextPart(DbgTextColor.InstanceProperty, NetSpy_Roslyn_Resources.DebuggerVarsWindow_Error_PropertyName));
