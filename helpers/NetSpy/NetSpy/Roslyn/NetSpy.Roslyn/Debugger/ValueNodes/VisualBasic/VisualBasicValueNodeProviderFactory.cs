...
namespace NetSpy.Roslyn.Debugger.ValueNodes.VisualBasic {
	sealed class VisualBasicValueNodeProviderFactory : DbgDotNetValueNodeProviderFactory {
		readonly DbgDotNetText instanceMembersName = new DbgDotNetText(new DbgDotNetTextPart(DbgTextColor.Text, NetSpy_Roslyn_Resources.DebuggerVarsWindow_InstanceMembers));
		readonly DbgDotNetText staticMembersName = new DbgDotNetText(new DbgDotNetTextPart(DbgTextColor.Text, NetSpy_Roslyn_Resources.DebuggerVarsWindow_VisualBasic_SharedMembers));
