...
using NetSpy.Roslyn.Documentation;
using NetSpy.Roslyn.Intellisense.Completions;
using NetSpy.Roslyn.Intellisense.QuickInfo;
using NetSpy.Roslyn.Intellisense.SignatureHelp;
using NetSpy.Roslyn.Internal.SignatureHelp;
using NetSpy.Roslyn.Text;
using NetSpy.Roslyn.Text.Tagging;
...
namespace NetSpy.Roslyn.Optimizations {
	[ExportAutoLoaded]
